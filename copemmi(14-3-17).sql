...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-03-2017 a las 04:00:47
...
(3, 'INAC', 'HORNOBIZCO', 'EDG78', '2-0742-0632', '2017-03-14', '2017-03-14');
...
--
ALTER TABLE `ordenes_fabricaciones`
  MODIFY `COD_ORDEN_FABRICACION` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
