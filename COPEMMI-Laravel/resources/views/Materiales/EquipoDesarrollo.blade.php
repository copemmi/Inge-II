...
<!--------------------------------------------------------------------TABLA EN EL CENTRO------------------------------------------------------>
		...
		<div class="content">
			...
			<div class="page-header">
				<h1 class="text-center">Equipo de Desarrollo</h1>
			</div>
			...
			<div class="container">
				...
				<div class="form-group">
					<div class="col-md-8">
						<h4>Josué Hidalgo.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4> 
				...
				<div class="form-group">
					<div class="col-md-8"> 
						<h4>Ricardo Vargas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4>
						<h4>Ingeniero en Sistemas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-briefcase"></i></span></h4>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <h4>Luis Carlos Sánchez.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4>
                        <h4>Ingeniero en Sistemas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-briefcase"></i></span></h4>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <h4>Johel López.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4>
                        <h4>Ingeniero en Sistemas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-briefcase"></i></span></h4>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <h4>Melvin Mora.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4>
                        <h4>Ingeniero en Sistemas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-briefcase"></i></span></h4>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                        <h4>María Laura Alfaro Espinoza.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span></h4>
                        <h4>Ingeniera en Sistemas.<span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-briefcase"></i></span></h4>
                    </div>
