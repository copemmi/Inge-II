//Inserta un tipo material en la lista de tipo materiales del combobox.  
function actualizaCombo()
{
  var cod_tipo_modelo =  $("#COD_TIPO_MODELO").val();//se captura el item que seleccione en el combobox
  var url="http://localhost:8000/ruta_tipo/"+cod_tipo_modelo;//ruta del método en el backend y sus parámetros
