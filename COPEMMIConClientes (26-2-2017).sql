...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2017 a las 04:38:02
...
INSERT INTO `clientes` (`ID`, `NOMBRE`, `PRIMER_APELLIDO`, `SEGUNDO_APELLIDO`, `DIRECCION`, `TELEFONO`, `CORREO`) VALUES
('1-0111-1111', 'l', 'l', 'l', 'k', '8444-88-99', 'kk@jhotmail.com'),
('2-0742-1270', 'Johel', 'Lopez', 'Alpizar', 'Alajuela', '8461-18-50', 'johelopezcr@hotmail.com');
...
(17, 'HORNOBIZCO', 'LAM-2m', 2),
(18, 'HORNOBIZCO', 'TR5', 7),
(19, 'HORNOBIZCO', 'LamAlum', 5),
(20, 'Prueba', 'LamAlum', 2),
(21, 'Prueba', 'LAM-2m', 5);
...
('HORNOBIZCO', 'Horn-Bizco', 'HORNPAN', 'Horno para Bizcochos', 'sirve para hacer bizcochos :v', 45000),
...
(1, 'INAC', 'HORNOBIZCO', 'EDG78', '2-0742-1270', '2017-02-25', '2017-02-25');
...
--
ALTER TABLE `det_modelos_maquinas`
  MODIFY `COD_DETALLE_MODELO` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `ordenes_fabricaciones`
  MODIFY `COD_ORDEN_FABRICACION` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `ordenes_fabricaciones`
  ...
  ADD CONSTRAINT `FK_MODMAQ_ORDFAB` FOREIGN KEY (`COD_MODELO`) REFERENCES `modelos_maquinas` (`COD_MODELO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `ordenes_fabricaciones_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `clientes` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
